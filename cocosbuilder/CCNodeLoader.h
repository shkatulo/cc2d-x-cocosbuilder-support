...
#define PROPERTY_CASCADE_OPACITY "cascadeOpacityEnabled"
#define PROPERTY_CASCADE_COLOR "cascadeColorEnabled"

#if COCOS2D_DEBUG
    #define ASSERT_FAIL_UNEXPECTED_PROPERTY(PROPERTY) cocos2d::log("[DEBUG] Unexpected property: '%s'!", PROPERTY);
    #define ASSERT_FAIL_UNEXPECTED_PROPERTYTYPE(PROPERTYTYPE) cocos2d::log("[DEBUG] Unexpected property type: '%d'!", PROPERTYTYPE);
#else
